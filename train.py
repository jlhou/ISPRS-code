...
flags.DEFINE_string('train_logdir', 'datasets\pascal_voc_seg\exp\\train_on_trainval_set\\train',
...
flags.DEFINE_integer('training_number_of_steps', 10,
...
flags.DEFINE_integer('crop_size', 513,
                          'Image crop size [height, width] during training.')

train_crop_size=[FLAGS.crop_size*1,FLAGS.crop_size*1]
...
flags.DEFINE_string('tf_initial_checkpoint', 'hello\\model.ckpt',
...
flags.DEFINE_integer('bas_rate', 6,
                          'Atrous rates for atrous spatial pyramid pooling.')

#atrous_rates=[FLAGS.bas_rate*1,FLAGS.bas_rate*2,FLAGS.bas_rate*3]
...
flags.DEFINE_string('dataset_dir', 'datasets\\pascal_voc_seg\\tfrecord', 'Where the dataset reside.')
...
def _build_deeplab(inputs_queue, outputs_to_num_classes, ignore_label):
  ...
  model_options = common.ModelOptions(
      ...
      atrous_rates=[FLAGS.bas_rate,FLAGS.bas_rate*2,FLAGS.bas_rate*3],
